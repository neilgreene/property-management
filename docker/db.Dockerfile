...
COPY sql/62_contract_gate.sql    /docker-entrypoint-initdb.d/62_contract_gate.sql
COPY sql/63_customer_contact.sql /docker-entrypoint-initdb.d/63_customer_contact.sql
