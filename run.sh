...
for f in sql/01_schema.sql sql/02_policies.sql sql/03_views.sql \
         ...
         sql/46_note_severity.sql sql/47_share.sql sql/48_mfa.sql sql/49_projection.sql sql/50_search_criteria.sql sql/51_customer_workflow.sql sql/52_search_screening.sql sql/53_workbook_extras.sql; do
